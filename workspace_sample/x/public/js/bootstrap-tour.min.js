    ...
    return o = window.document, e = function() {
        function e(e) {
            ...
            this._options = t.extend({
                ...
                delay: !1,
                basePath: "",
                template: '<div class="popover" role="tooltip"> <div class="arrow"></div> <h3 class="popover-title"></h3> <div class="popover-content"></div><hr style="margin:5px;"> <div class="popover-navigation"> <div class="btn-group">  <button class="btn btn-sm btn-default" data-role="pause-resume" data-pause-text="Pause" data-resume-text="Resume">Pause</button> </div> <button class="btn btn-sm btn-default pull-right" data-role="end">我知道了</button> </div> </div>',
