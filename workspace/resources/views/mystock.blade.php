...
$GLOBALS['url'] = '';
  if(isset($response['result']['parameters']['stockname'])){
    ...
    $GLOBALS['url'] = $url;
      ...
      $url = "http://chatbot-joey820924.c9users.io/mystocks?allstock=".$response['result']['parameters']['allstock'];
      $GLOBALS['url'] = $url;
  }
  else if(isset($response['result']['parameters']['Finish'])){
      $url = "http://chatbot-joey820924.c9users.io/mystocks?finish=leave";
      $GLOBALS['url'] = $url;
  }
  else if(isset($response)){
        $url = "http://chatbot-joey820924.c9users.io/mystocks";
        $GLOBALS['url'] = $url;
        }
?>
<?php
