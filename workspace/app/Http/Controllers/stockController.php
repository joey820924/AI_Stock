...
class stockController extends Controller
{
	    ...
	    public function index(Request $request)
    {
        ...
        if( $request["ilt"] !="" ){
            ...
            $fiterMessage.=" 指標小於".$request["ilt"]."%";


        }
        if(isset($sindex)){
            if(isset($igt)&&isset($ilt)){
                
                $stocks =  ystock::where("price",">",$pl)->where("price","<",$pt)->where($sindex,">",$igt)->where($sindex,"<",$ilt)->get();
            }
            else if(isset($igt)){
                $stocks =  ystock::where("price",">",$pl)->where("price","<",$pt)->where($sindex,">",$igt)->get();
            }
            else{
                $stocks =  ystock::where("price",">",$pl)->where("price","<",$pt)->where($sindex,"<",$ilt)->get();
            }
        }
        else{
            $stocks =  ystock::where("price",">",$pl)->where("price","<",$pt)->get();
        }
        ...
        $allstock = markets::where("name","=",$request['allstock'])->first();
        return view('stocks',compact("stocks","fiterMessage","allstock"));
    }
    ...
    public function dashboard(Request $request)
    {
        ...
        $stock = ystock::where("name","=",$request["name"])->first();
        $allstock = markets::where("name","=",$request['allstock'])->first();
        if(Count($mystocks)>5){
             return view('home2',compact("mystocks","invest","user","winRate","nw","stock","allstock"));
        }
        else{
            return view('home',compact("mystocks","invest","user","winRate","nw","stock","allstock"));
        }
    ...
    public function mystocks(Request $request)
    {
        ...
        return view('mystock',compact("mystocks","invest","user","winRate","nw","allstock"));
    ...
    public function myfollows(Request $request)
    {
        ...
        return view('myfollow',compact("mystocks","invest","user","winRate","nw","allstock"));
    ...
    {
        $allstock = markets::where("name","=",$request['allstock'])->first();
        return view('mysubscribe',"allstock");

    }



    public function user2($request)
    {
        $allstock = markets::where("name","=",$request['allstock'])->first();
        return view('user2',"allstock");
    ...
    public function stock_detail($id,Request $request)
    {
        $stock = ystock::where("id","=",$id)->first();

        $allstock = markets::where("name","=",$request['allstock'])->first();
        return view('stock_detail',compact("stock","application"));
    }
    
    public function stockcode_detail($code,Request $request)
    {
        $stock = ystock::where("code","=",$code)->first();

        $allstock = markets::where("name","=",$request['allstock'])->first();
        return view('stock_detail',compact("stock","allstock"));
    }
